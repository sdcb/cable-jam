...
LRESULT CALLBACK Window::StaticWndProc(HWND hwnd, UINT message, WPARAM wParam, LPARAM lParam) {
    ...
    return window ? window->WndProc(message, wParam, lParam) : DefWindowProcW(hwnd, message, wParam, lParam);
}
...
void Window::ForwardMouse(UINT message, LPARAM lParam) {
    ...
    const auto transform = app_->RenderContext().ViewTransform();
    const core::Point logical = core::ToLogical(
